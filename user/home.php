                                        ...
                                        <form action="" method="post">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control" name="hinhthuc" id="ht" required>
                                                    ...
                                                    <option value="Học bạ" <?php echo ($_SESSION["hinhthuc"] == "Học bạ") ? "selected" : ""; ?>>Học bạ</option>
                                                    <option value="Điểm thi THPT quốc gia" <?php echo ($_SESSION["hinhthuc"] == "Điểm thi THPT quốc gia") ? "selected" : ""; ?>>Điểm thi THPT quốc gia
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="row mb-3">
